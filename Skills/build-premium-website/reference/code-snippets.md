...
These are starting skeletons. Substitute brand colors and copy from intake. The full reference markup for any unclear section lives in the bundled file `${CLAUDE_SKILL_DIR}/reference/full-reference-app.jsx` — open it by line range from `structure.md`.
