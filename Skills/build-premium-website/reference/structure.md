...
All sections live in `src/App.jsx` as one file. Build them in this order. Line ranges below refer to the bundled reference file at `${CLAUDE_SKILL_DIR}/reference/full-reference-app.jsx` — open and read those line ranges when you need the exact markup.
